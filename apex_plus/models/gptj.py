...
class GPTJ(ApexModel):
    ...
    @classmethod
    def from_hf(cls, config: GPTJConfig) -> "GPTJ":
        return cls(
    ...
    def to_ir(self) -> Transformer:
        layer = ParallelMHAMLP(self.num_heads, self.hidden_size, self.intermediate_size)
    ...
    def __repr__(self) -> str:
        return (
            f"GPTJ(vocab_size={self.vocab_size}, "
