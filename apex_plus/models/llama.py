...
class LLaMA(ApexModel):
    ...
    @classmethod
    def from_hf(cls, config: LlamaConfig) -> "LLaMA":
        return cls(
    ...
    def to_ir(self) -> Transformer:
        ...
        mlp = GLU(self.hidden_size, self.intermediate_size)
    ...
    def __repr__(self) -> str:
        return (
            f"LLaMA(vocab_size={self.vocab_size}, "
