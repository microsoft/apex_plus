...
class T5(ApexModel):
    ...
    @classmethod
    def from_hf(cls, config: T5Config) -> "T5":
        return cls(
            vocab_size=config.vocab_size,
            num_encoder_layers=config.num_layers,
            num_encoder_heads=config.num_heads,
            encoder_hidden_size=config.d_kv * config.num_heads,
            encoder_intermediate_size=config.d_ff,
            num_decoder_layers=config.num_decoder_layers,
            num_decoder_heads=config.num_heads,
            decoder_hidden_size=config.d_kv * config.num_heads,
            decoder_intermediate_size=config.d_ff,
        )
    ...
    def __repr__(self) -> str:
        return (
            f"T5(vocab_size={self.vocab_size}, "
            ...
            f"intermediate_size={self.encoder_intermediate_size})"
        )
